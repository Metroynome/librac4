...
VariableAddress_t vaGetTextWidthFunc = {
    ...
    .Stygia = 0x0050BF70,
    .Maraxus = 0x00525830,
    .GhostStation = 0x0051E648,
    .DreadZoneInterior = 0x005300F0,
};
VariableAddress_t vaDrawTextFunc = {
    .MainMenu = 0x00455288,
    .Battledome = 0x005613A0,
    .Catacrom = 0x005134A0,
    .Sarathos = 0x00513708,
    .Kronos = 0x00537D48,
    .Shaar = 0x0050B078,
    ...
    .Stygia = 0x0050C260,
    .Maraxus = 0x00525B20,
    .GhostStation = 0x0051E938,
    .DreadZoneInterior = 0x005303E0,
};
#elif RAC4_NTSCJ || RAC4_NTSCK
VariableAddress_t vaGetTextWidthFunc = {
    .MainMenu = 0x004786B0,
    .Battledome = 0x005795E8,
    .Catacrom = 0x0052BB10,
    .Sarathos = 0x0052BFA8,
    .Kronos = 0x00550428,
    .Shaar = 0x00523B98,
    ...
    .Stygia = 0x00524C00,
    .Maraxus = 0x0053E140,
    .GhostStation = 0x00536F98,
    .DreadZoneInterior = 0x00548AD8,
};
VariableAddress_t vaDrawTextFunc = {
    .MainMenu = 0x004789A0,
    .Battledome = 0x005798D8,
    .Catacrom = 0x0052BE00,
    .Sarathos = 0x0052C298,
    .Kronos = 0x00550718,
    .Shaar = 0x00523E88,
    ...
    .Stygia = 0x00524EF0,
    .Maraxus = 0x0053E430,
    .GhostStation = 0x00537288,
    .DreadZoneInterior = 0x00548DC8,
};
#else
VariableAddress_t vaGetTextWidthFunc = {
    .MainMenu = 0x00454780,
...
{
	int player = *(u32*)heroStructPointerAddress;
